...
class Options():
    ...
    def initialize(self):
        ...
        # ------------------------ selfagent
        self.parser.add_argument('--rkdgloss_weight', type=float, default=10) # integrated
        ...
        self.parser.add_argument('--crosslogitdistloss_weight_st2ss', type=str, default='0.1') # split by _
        self.parser.add_argument('--crosslogitdistloss_weight_tt2st', type=str, default='0.1')
        ...
        self.parser.add_argument('--crosslogitsimloss_weight_st2ss', type=str, default='0.1') # split by _
        self.parser.add_argument('--crosslogitsimloss_weight_tt2st', type=str, default='0.1')
        ...
        self.parser.add_argument('--crosslogitgeodistloss_weight_st2ss', type=str, default='0.1') # only one mapping
        self.parser.add_argument('--crosslogitgeodistloss_weight_tt2st', type=str, default='0.1')
